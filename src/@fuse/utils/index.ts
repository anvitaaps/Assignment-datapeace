export class FuseUtils
{
    ...
    public static filterArrayByStringRadio(mainArr, searchText)
    {
        if ( searchText === '' )
        {
            return mainArr;
        ...
        return mainArr.filter(itemObj => {
            return this.searchInObjRadio(itemObj, searchText);
        });
    }
    ...
    public static searchInObjRadio(itemObj, searchText)
    {
        for ( const prop in itemObj )
        {
            ...
            if ( typeof value === 'string' )
            { 
                if ( this.searchInStringRadio(value, searchText) )
                {
                    return true;
                }
            }
    ...
    public static searchInStringRadio(value, searchText)
    {
        // console.log(value, searchText, value.localeCompare(searchText))
        // return value.toLowerCase().includes(searchText);
