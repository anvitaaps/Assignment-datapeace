export class MailFakeDb
{
    public static notifications = [
        {'type':'critical', 'action_status': 'Pending', 'check': 'more_horiz', 'class': 'orange-icon', 'icon': 'error', 'mins': '6', 'title': 'Temperature High', 'sub_title': 'Run R11-003 Process P200-123 AMS 1011', 'generated': 'Jun 11, 11:52', 'status': 'Resolve by'},
    {'type':'critical','action_status': 'Resolved','check': 'play_circle_filled','class': 'orange-icon', 'icon': 'error', 'mins': '10', 'title': 'Feed Rate High', 'sub_title': 'Run R11-003 Process P200-123 AMS 1011', 'generated': 'Jun 11, 11:52', 'status': 'Resolve by'},
    {'type':'warning','action_status': 'Pending','check': 'more_horiz','class': 'yellow-icon', 'icon': 'warning', 'mins': '10', 'title': 'Warning', 'sub_title': 'Run R11-003 Process P200-123 AMS 1011', 'generated': 'Jun 11, 11:52', 'status': 'Resolve by'},
    {'type':'info','action_status': 'Resolved','check': 'play_circle_filled','class': 'green-icon', 'icon': 'warning', 'mins': '10', 'title': 'Information Alert', 'sub_title': 'Run R11-003 Process P200-123 AMS 1011', 'generated': 'Jun 11, 11:52', 'status': 'Do not resolve'}]
    public static mails = [
        {
